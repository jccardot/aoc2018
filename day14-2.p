...
&GLOBAL-DEFINE xcRecipes "793031"
&GLOBAL-DEFINE xiRecipes 6
...
DEFINE VARIABLE iRecipes   AS INTEGER     NO-UNDO.
...
DO WHILE TRUE:
    IF iRecipeSeq MODULO 1000 = 0 THEN DISP iRecipeSeq.
    ...
    /* end condition */
    IF iRecipeSeq > {&xiRecipes} THEN DO:
        cRecipes = "".
        DO i = {&xiRecipes} TO 1 BY -1:
            FIND ttRecipe WHERE ttRecipe.id = iRecipeSeq - i.
            cRecipes = cRecipes + STRING(ttRecipe.iRecipeScore).
        END.
        IF cRecipes = {&xcRecipes} THEN DO:
            iRecipes = iRecipeSeq - {&xiRecipes} - 1.
            LEAVE.
        END.
        cRecipes = SUBSTRING(cRecipes, 2).
        FIND ttRecipe WHERE ttRecipe.id = iRecipeSeq.
        cRecipes = cRecipes + STRING(ttRecipe.iRecipeScore).
        IF cRecipes = {&xcRecipes} THEN DO:
            iRecipes = iRecipeSeq - {&xiRecipes}.
            LEAVE.
        END.
    END.
    /* move the elves */
